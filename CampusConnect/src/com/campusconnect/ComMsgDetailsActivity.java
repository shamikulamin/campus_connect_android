...
public class ComMsgDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String enc_user = getIntent().getStringExtra("enc_user");
        String enc_pass = getIntent().getStringExtra("enc_pass");
        
        vConnector = new ServerConnector(ComMsgDetailsActivity.this, enc_user, enc_pass);
